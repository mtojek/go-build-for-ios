...
* There is a different project targetted for mobile devices. If you don't want to see how to build applications using standard Go SDK, most likely you'd like to use that one ([GoMobile](https://godoc.org/golang.org/x/mobile)).
